import 'package:doctor_call/screen/order_details.dart';
      ...
      body:ListView.builder(
        ...
        itemBuilder: (BuildContext context, index){
          ...
          return Padding(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OrderDetails(calldata)));
                  },
                  child: Container(
                    child: Padding(
